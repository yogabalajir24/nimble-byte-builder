  ...
  return <section id="projects" className="py-20 bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => <Card key={index} className="bg-gray-900 border-gray-700 hover:border-blue-400 transition-all duration-300 hover:scale-105">
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.technologies.map((tech, techIndex) => <span key={techIndex} className="px-3 py-1 bg-gray-700 text-blue-400 text-sm rounded-full">
                      {tech}
                    </span>)}
                </div>
                <div className="flex gap-3">
                  <Button onClick={handleGitHubRedirect} variant="outline" size="sm" className="border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-gray-900">
                    <ExternalLink className="h-4 w-4 mr-2" />
                    Live Demo
                  </Button>
                  <Button onClick={handleGitHubRedirect} variant="outline" size="sm" className="border-gray-600 bg-slate-600 hover:bg-slate-500 text-gray-50">
